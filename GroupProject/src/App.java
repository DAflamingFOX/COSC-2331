...
public class App {
		...
		frame.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e ) {
				for(Window w : frame.getOwnedWindows()) {
					if (w instanceof CalculatorPopup) {
						((CalculatorPopup) w).close();
					}
				}
				frame.dispose();
	...
	private class SwingActionCircle extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			calculator.setIconImage(null);
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/circle-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}		
	}
	private class SwingActionCube extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			Logger.log("Cube button pressed.");
			CalculatorPopup calculator = new CalculatorPopup(frame, "Cube");
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/cube-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
	private class SwingActionTriangle extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/triangle-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
	private class SwingActionRectangularPrism extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			Logger.log("Rectangular Prism button pressed.");
			CalculatorPopup calculator = new CalculatorPopup(frame, "Rectangular Prism");
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/rectprism-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
	private class SwingActionSquare extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/square-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
	private class SwingActionCylinder extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			Logger.log("Cylinder button pressed.");
			CalculatorPopup calculator = new CalculatorPopup(frame, "Cylinder");
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/cyl-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
	private class SwingActionRectangle extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			Logger.log("Rectangle button pressed.");
			CalculatorPopup calculator = new CalculatorPopup(frame, "Rectangle");
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/rec-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
	private class SwingActionCone extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			Logger.log("Cone button pressed.");
			CalculatorPopup calculator = new CalculatorPopup(frame, "Cone");
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/cone-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
	private class SwingActionParallelogram extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			Logger.log("Parallelogram button pressed.");
			CalculatorPopup calculator = new CalculatorPopup(frame, "Parallelogram");
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/parallel-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
	private class SwingActionSphere extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			Logger.log("Sphere button pressed.");
			CalculatorPopup calculator = new CalculatorPopup(frame, "Sphere");
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/sphere-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
	private class SwingActionTrapezoid extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			Logger.log("Trapezoid button pressed.");
			CalculatorPopup calculator = new CalculatorPopup(frame, "Trapezoid");
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/trap-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
	private class SwingActionHemisphere extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			Logger.log("Hemisphere button pressed.");
			CalculatorPopup calculator = new CalculatorPopup(frame, "Hemisphere");
			calculator.setIconImage(Toolkit.getDefaultToolkit().getImage(App.class.getResource("/resources/hemi-cal.png")));
			calculator.setSize(700, 300);
			calculator.show();
		}
	}
